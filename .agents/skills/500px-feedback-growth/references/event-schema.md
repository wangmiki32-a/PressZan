...
```json
{"kind":"candidate_skipped","occurred_at":"2026-08-19T12:00:00+08:00","data":{"photographer_id":"p1","reason":"latest_work_already_liked","quota_bucket":"new"}}
```
...
| `candidate_skipped` | `photographer_id`, `reason` | `photo_id`, `quota_bucket`（旧日志兼容；新运行必填） |
